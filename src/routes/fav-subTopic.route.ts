...
export class Fav_SubTopicRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.post(`${this.path}`, ValidationMiddleware(CreateUser_SubtopicDto, 'body',true), this.user_subTopic.setSubTopicAsFavourite);
    this.router.delete(`${this.path}`,ValidationMiddleware(CreateUser_SubtopicDto, 'body',true), this.user_subTopic.removeSubTopicAsFavourite);
